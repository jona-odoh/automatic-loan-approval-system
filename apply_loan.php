    ...
    <div class="header">
        <div class="container">
            <div class="row">
               ...
               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-right"> <a href="car_loan.php" class="btn btn-primary btn-xs mt20">Back to Page</a></div>
            </div>
        </div>
        <!-- .container -->
    </div>
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="hero-captions">
                        ...
                        <a href="#" class="btn btn-default btn-sm">Why Choose us ?</a>
                    </div>
                </div>
...
"></i>
                            ...
                            <span class="testimonial-name-inverse">Donny J. Griffin (baroda)</span></div>
                    </div>
                </div>
                <!-- /.testimonial simple start -->
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
        ...
        <div class="container">
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12">
                    ...
                    <h1>Ask about our low rate car loans?</h1>
                    <p></p>
                    <a href="#" class="btn btn-primary">Get Started Now</a>
                </div>
                <div class="offset-xl-1 col-xl-7 offset-lg-1 col-lg-7 col-md-6 col-sm-12 col-12">
