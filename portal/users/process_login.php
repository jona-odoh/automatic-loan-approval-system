...
function clean($str) {
	...
	if($result) {
		if(mysqli_num_rows($result) > 0) {
			...
			$_SESSION['SESS_PHONE_NUMBER'] = $member['contact_no'];
			$_SESSION['SESS_EMAIL'] = $member['email'];
			$_SESSION['SESS_TAX_NO'] = $member['tax_no'];
			$_SESSION['SESS_NATIONAL_ID'] = $member['national_id'];
			$_SESSION['SESS_OCCUPATION'] = $member['occupation'];
