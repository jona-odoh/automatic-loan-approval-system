                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                          <?php
                            ...
                            $result = $db->prepare("SELECT b.*, u.photo FROM borrower b INNER JOIN admin u ON b.user_id = u.id WHERE b.approval_status = '' ");
                            $result->execute();
                          ...
                          <tr>
                            ...
                            <td class="gallery">
                            <img alt="image" src="../uploads/<?php echo $row['photo']; ?>" class="gallery-item rounded-circle" data-image="../uploads/<?php echo $row['photo']; ?>" data-title="Image 8" width="35"
                                ...
                                <div class="card-header-action">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a href="approval_status.php?id=<?php echo $row['id']; ?>&action=pay" class="dropdown-item has-icon">
                                                <i class="fas fa-check-circle"></i> Pay
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a href="approval_status.php?id=<?php echo $row['id']; ?>&action=reject" class="dropdown-item has-icon text-danger">
