                  ...
                  <div class="card-body">
                    <div class="author-box-center">
                      ...
                      if (!empty($row['photo'])) {
                        ...
                        echo '<img src="default.jpg" class="rounded-circle author-box-picture">';
                      }
                      ?>
                  ...
                  <div class="padding-20">
                    ...
                    <div class="tab-content tab-bordered" id="myTab3Content">
                      <div class="tab-pane fade show active" id="about" role="tabpanel" aria-labelledby="home-tab2">
                        <form method="post" action="save_admin.php?id=<?php echo $row['id'];?>" enctype="multipart/form-data" class="needs-validation">
