                      ...
                      <table class="table table-striped table-hover" id="tableExport" style="width:100%;">
                        ...
                        <tbody>
                          <?php
                            ...
                            $result = $db->prepare("SELECT b.*, u.photo FROM borrower b 
                            INNER JOIN admin u ON b.user_id = u.id WHERE b.approval_status = 'paid' ");
                            $result->execute();
                          ...
                          <tr>
                            ...
                            <td>
                              ...
                              if($row['payment_status'] == "cleared"){
                                echo "<p class='badge badge-success'>Paid Complete</p>";   
                              } else {
                                echo "<p class='badge badge-danger'>Not Paid</p>";
                              }     
                            ?>   </div>
                            </td>
                            <td>
